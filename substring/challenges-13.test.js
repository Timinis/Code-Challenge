...
// For example, 'abcdefg' should return 'bdf'.
// ------------------------------------------------------------------------------------------------
...
// should return [['Actual Person'], ['Human Person']].
// ------------------------------------------------------------------------------------------------
...
//
// For example, ['Tuesday', 'Monday', 'Wednesday and Thursday', 'Tuesday 2', 'Thursday']
// should return [
//   ['Monday'],
//   ['Tuesday', 'Tuesday 2'],
...
// For example, ['abcd', 'efgh', 'ijkl', 'mnop'] should return ['a', 'f', 'k', 'p'].
// ------------------------------------------------------------------------------------------------
