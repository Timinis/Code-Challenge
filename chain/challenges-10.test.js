...
Write a function that, given an array of integer arrays as input, either filter, map, or reduce to calculate the total sum of all the elements in the array.
...
const totalSum = input => {
  // Solution code here...
  return input.reduce((accumulator, currentValues) => {
    let sum = currentValues.reduce((acc, cV) => {
      return acc + cV;
    });
