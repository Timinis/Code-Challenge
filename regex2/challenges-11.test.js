...
const validatePin = pin => {
  ...
  let result = stringPin.match(/[0-9]/g);
  console.log(result);
  if (result === null) {
    return false;
  }
...
For example, findTagNames(['<h1>Hello, world!</h1>', '<p>Welcome to my site</p>']) returns ['/h1', '/p'], and findTagNames(['<div><h1>Hello, world!</h1></div>', '<p>Welcome to my site</p>']) returns ['/h1', '/div', '/p'].
------------------------------------------------------------------------------------------------*/
